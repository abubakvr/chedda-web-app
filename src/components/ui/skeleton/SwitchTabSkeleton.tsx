...
export const SwitchTabSkeleton = ({}) => {
  return (
    ...
    >
      <div className="flex bg-mist h-8 md:h-10 lg:h-11 w-full rounded-lg justify-between p-2 opacity-40"></div>
      <div className="flex flex-col mt-4 md:mt-6">
        ...
        ></div>
        <div className="flex bg-mist  h-8 md:h-10 lg:h-11 w-full rounded-lg justify-between p-2 opacity-40 mb-5"></div>
        <div className="flex bg-mist  h-8 md:h-10 lg:h-11 w-full rounded-lg justify-between p-2 opacity-40 mb-5"></div>
        <div
          data-testid={`skeleton-item-element-1`}
