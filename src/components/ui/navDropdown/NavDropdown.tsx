...
export const NavDropdown: React.FC<DropdownMenuProps> = ({ menuItems }) => {
  ...
  return (
    <div className="relative" data-testid="nav-dropdown">
      ...
      <ul
        className={`more-dropdown p-2 transition-all duration-300 ease-in-out absolute mt-1 w-28 left-0 bg-[#000B1EA3] menu-ng text-white rounded-sm shadow-lg z-10 font-bold ${
