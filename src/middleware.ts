...
export async function middleware(request: NextRequest) {
  ...
  const cspHeader = `
    default-src 'self';
    connect-src 'self' https://*.alchemy.com https://*.infura.io/ https://api-testnet.layerzero-scan.com/ https://www.google-analytics.com/ https://api.ipstack.com/ https://leaderboard-api-422055794768.us-central1.run.app/ https://chedda.app.n8n.cloud/;
